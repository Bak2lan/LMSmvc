...
public class CourseController {
    ...
    public String getCourse(@PathVariable("courseId")Long courseId,@PathVariable("companyId")Long companyId,Model model){
        Company company=companyService.getById(companyId);
        Course course=courseService.getCourseById(courseId);
        model.addAttribute("allInstructors",company.getInstructors());
        model.addAttribute("instr",course.getInstructor());
        model.addAttribute("course",course);
        model.addAttribute("company",company);
        model.addAttribute("allGroupsCourses",course.getGroups());
        model.addAttribute("allLessons", course.getLessons());
